...
import { reloadPageSnackBar } from "./lib/snackBars";
...
function registerValidSW(swUrl, store) {
  ...
  // store.dispatch(enqueueSnackbar(cacheInfosSnackBar()));
  navigator.serviceWorker
    ...
    .then(registration => {
      ...
      //   setTimeout(
      //     () => store.dispatch(closeFixedSnackbar("cacheInfos")),
      //     2000,
      //   );
      // }
        ...
        installingWorker.onstatechange = () => {
          if (installingWorker.state === "installed") {
            if (navigator.serviceWorker.controller) {
              ...
              // store.dispatch(closeFixedSnackbar("cacheInfos"));
              store.dispatch(enqueueSnackbar(reloadPageSnackBar()));
            } else {
